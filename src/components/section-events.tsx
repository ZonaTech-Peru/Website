                        ...
                        <div className="card__content">
                            <div className="card__header">
                                ...
                                <StaticImage className='img'
                                    src="../images/taller1.png" // Ruta a tu archivo SVG relativa a la carpeta de imágenes
                    ...
                    <article className="card">
                        <div className="card__content">
                            <div className="card__header">
                                ...
                                <StaticImage className='img'
                                    src="../images/charla1.png" // Ruta a tu archivo SVG relativa a la carpeta de imágenes
                                    alt="Descripción de la imagen"
                                    placeholder="blurred" // Opciones de carga, como "tracedSVG", "dominantColor", etc.
                                    />
                            </div>
